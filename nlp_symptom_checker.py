...
def correct_spelling(symptom):
    ...
    if corrected_symptom:
        return corrected_symptom[0]
    else:
        return None

# Example usage
misspelled_symptom = input("Enter a misspelled symptom: ")
corrected_symptom = correct_spelling(misspelled_symptom)
print("Misspelled Symptom:", misspelled_symptom)
print("Corrected Symptom:", corrected_symptom)